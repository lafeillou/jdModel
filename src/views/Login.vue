    ...
    <div class="page">
      <div class="header">
        <a
          ...
          ><span class="d"></span
        ></a>
        <span class="text_header">京东登录注册</span>
      </div>
      <div class="inputbox">
        ...
        <p class="input_container">
          ...
          <span class="text_btn">获取验证码</span>
        </p>
      </div>
      <div class="n"></div>
      <button class="btn_login">登录</button>
      <p class="quick_btn">
        <span class="planBLogin">账号密码登录</span>
        <span class="quickReg">手机快速注册</span>
      </p>
      <div class="quick_login">
        <h4 class="txt_otherLogin">其他登录方式</h4>
        <p class="quik_type">
          <a class="quik_qq">QQ</a>
        </p>
      </div>
      <p class="policy_tip">
